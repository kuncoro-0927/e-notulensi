    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="container-fluid" style="display: flex">
          <main class="main absolute">
            ...
            <table id="tabelUnit" class="table table-striped table-bordered" style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-edit" data-toggle="modal" data-target="#tambahUnitModal{{$unit->id}}">Edit</button>
                    <button class="btn btn-hapus" onclick="hapusUnit(1)">Hapus</button>
                  </td>
                </tr>
                @endforeach
            ...
            <div id="confirmModal" class="confirm-modal">
              <div class="confirm-box">
                ...
                <button class="ok float-right" onclick="hapusUnitKonfirmasi(true)">Ya</button>
                <button class="cancel" onclick="hapusUnitKonfirmasi(false)">Tidak</button>
              </div>
            </div>
          </main>
          ...
          <!-- Modal Edit Unit -->
          <div class="modal" tabindex="-1" role="dialog" id="editUnitModal">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
