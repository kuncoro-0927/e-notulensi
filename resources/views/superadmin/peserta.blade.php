...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid" style="display: flex">
          ...
          <main class="main absolute">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <!-- tambah sekre -->
              <button class="btn btn-primary tambah-button" data-toggle="modal" data-target="#tambahPesertaModal"><i class="fas fa-plus"></i> Tambah</button>
            </div>
            ...
            <table id="tabelPeserta" class="table table-striped table-bordered" style="width: 100%">
              ...
              <tbody>
                ...
                <td>{{ $data->jabatan }}</td>
                  <td>
                    <button class="btn btn-edit" data-toggle="modal" data-target="#editPesertaModal{{$data->id}}" >Edit</button>
                    <button class="btn btn-hapus" onclick="hapusPeserta(1)">Hapus</button>
                  </td>
                  @endforeach
                </tr>
            ...
            <div id="confirmModal" class="confirm-modal">
              <div class="confirm-box">
                ...
                <button class="ok float-right" onclick="hapusPesertaKonfirmasi(true)">Ya</button>
                <button class="cancel" onclick="hapusPesertaKonfirmasi(false)">Tidak</button>
              </div>
            </div>
          </main>

          <!-- Modal Tambah Peserta -->
          <div class="modal" tabindex="-1" role="dialog" id="tambahPesertaModal">
            ...
            @endif
                ...
                <div class="modal-body">
                  <form action="{{ route('superadmin.tambahpeserta') }}" method="POST">
                    @csrf
          ...
          @foreach ($datas as $data)
          <!-- Modal Edit Peserta -->
          <div class="modal" tabindex="-1" role="dialog" id="editPesertaModal{{$data->id}}" >
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
      ...
      // Menggunakan modifikasi fungsi hapus Peserta
      ...
      function hapusPesertaKonfirmasi(confirmation) {
        // Sembunyikan modal konfirmasi hapus
        hideConfirmModal();

        // Jika dikonfirmasi (OK), hapus data Peserta
        if (confirmation) {
          console.log("Hapus Peserta dengan ID: " + idToDelete);
        }
      }
    </script>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function hideTambahPesertaModal() {
          $("#tambahPesertaModal").modal("hide");
        }

        // event listener ke tombol "Tambah"
        document.querySelector(".tambah-button").addEventListener("click", showTambahPesertaModal);

        // event listener ke tombol "Simpan" di dalam modal
        document.querySelector("#tambahPesertaModal .btn-primary").addEventListener("click", function () {
          console.log("Simpan data peserta");

          // Setelah menyimpan, sembunyikan modal
          hideTambahPesertaModal();
        });
      });
    </script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        $("#editPesertaModal").modal({
          ...
          var id = $(this).data('id');
            ...
            // Setel nilai data pada formulir modal
            $('#edit_id').val(id);
            $('#edit_nama').val(nama);
        ...
        // Fungsi untuk menyembunyikan modal
        function hideEditPesertaModal() {
          $("#editPesertaModal").modal("hide");
        }

        // event listener ke tombol "Edit"
        document.querySelector(".btn-edit").addEventListener("click", showEditPesertaModal);

        // event listener ke tombol "Simpan" di dalam modal
        document.querySelector("#EditPesertaModal .btn-primary").addEventListener("click", function () {
          console.log("Simpan data peserta");

          // Setelah menyimpan, sembunyikan modal
          hideEditPesertaModal();
        });
      });
    </script>

    <script>
      new DataTable("#tabelPeserta");
    </script>
