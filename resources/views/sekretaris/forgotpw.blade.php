...
<html lang="en">
  ...
  <body style="background-color: #242564">
      ...
      <div class="card" style="max-width: 400px; margin: auto; background-color: #ffffff; border-radius: 15px; padding: 20px">
        ...
        <form>
          ...
          <div class="d-flex justify-content-center align-items-center">
            <button class="btn btn-primary mr-2 mt-3" style="height: 38px; line-height: 20px; border-radius: 10px" onclick="backLogin()">
              <i class="fa-solid fa-arrow-left" style="color: #ffffff; font-size: 18px"></i>
            </button>
            <button type="submit" class="btn btn-warning btn-block mt-3" style="border-radius: 10px; height: 38px; line-height: 20px" onclick="resetPaswword()">Continue</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <script>
      ...
      function backLogin() {
        console.log("backLogin function called");
